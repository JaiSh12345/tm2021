            ...
            <section id="contact" className="section-bg wow fadeInUp">
                <div className="container">
                    ...
                    <div className="form">
                        ...
                        <form data-bss-recipient="d44090abfbc5382e2075b0fe576497ad" role="form" className="contactForm">
                            ...
                            <div className="form-group">
                                <input type="text" className="form-control" name="subject" id="subject" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter at least 4 chars of subject" />
                                <div className="validation"></div>
                            </div>
                            <div className="form-group">
